...
def tree_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print "Cantidad de nodos expandidos: ", contador
            return node
...
def ramificacion_y_acotacion_subestimacion(problem):
    """Busqueda por ramificacion y salto"""
    return tree_search(problem, BBSQueue(problem))
...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            print "Cantidad de nodos expandidos: ", cont
            return node
